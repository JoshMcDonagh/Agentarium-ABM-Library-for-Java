...
class AttributeSetResultsDatabaseTest {

    private TestAttributeSetResultsDatabase database;

    @BeforeEach
    void setUp() {
        database = new TestAttributeSetResultsDatabase();
    }
    ...
    static class TestAttributeSetResultsDatabase extends AttributeSetResultsDatabase {
