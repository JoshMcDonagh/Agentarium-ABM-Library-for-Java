...
import modelarium.attributes.results.databases.MemoryBasedAttributeSetResultsDatabase;
...
/**
 * Unit tests for {@link MemoryBasedAttributeSetResultsDatabase}.
 *
 * <p>Verifies correct in-memory storage and retrieval of properties and event values.
 */
public class MemoryBasedAttributeSetResultsDatabaseTest {

    private MemoryBasedAttributeSetResultsDatabase database;

    @BeforeEach
    public void setUp() {
        database = new MemoryBasedAttributeSetResultsDatabase();
    }
