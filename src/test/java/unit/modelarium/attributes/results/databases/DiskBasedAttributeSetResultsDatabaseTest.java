...
import modelarium.attributes.results.databases.DiskBasedAttributeSetResultsDatabase;
...
/**
 * Unit tests for {@link DiskBasedAttributeSetResultsDatabase}.
 *
 ...
 */
public class DiskBasedAttributeSetResultsDatabaseTest {

    private DiskBasedAttributeSetResultsDatabase database;

    @BeforeEach
    public void setUp() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        database = new DiskBasedAttributeSetResultsDatabase();

        Method setDatabasePathMethod = AttributeSetResultsDatabase.class
